namespace Console.DataLayer
{
    ...
    public partial class Charity
    {
        ...
        /// </summary>
        [Column("SIREN")] // [Column(@"SIREN", Order = 10, TypeName = "nvarchar(max)")]
        [Display(Name = "Siren")]
        ...
        /// </summary>
        [Column(@"RepresentativeID", Order = 12, TypeName = "int")] // [Column("RepresentativeID")]
        ...
        /// </summary>
        [ForeignKey("RepresentativeId"), Required] // [ForeignKey("RepresentativeId")]
        [InverseProperty("Charities")]
